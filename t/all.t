...
ALTER TABLE asset_waypoint DROP PARTITION p23; # was VALUES \'LESS\' THAN \'23\'
ALTER TABLE asset_waypoint ADD PARTITION (PARTITION p23 VALUES LESS THAN (24));
ALTER TABLE asset_waypoint ADD PARTITION (PARTITION p24 VALUES LESS THAN (MAXVALUE));
',
  ],
);
