...
ALTER TABLE asset_waypoint DROP PARTITION p22; # was VALUES \'LESS\' THAN \'22\'
ALTER TABLE asset_waypoint ADD PARTITION (PARTITION p22 VALUES LESS THAN (23));
ALTER TABLE asset_waypoint ADD PARTITION (PARTITION p23 VALUES LESS THAN (MAXVALUE));
',
  ],
);
